...
- `frontend/src/data/index.ts` - Barrel exports for seed data and validation.
...
- [x] 2.0 Create seed data for vibes, occasions, difficulty, alcohol levels, and cocktails
  - [x] 2.1 Define seed lists for `Vibe`, `Occasion`, `Difficulty`, and `AlcoholLevel` with stable IDs
